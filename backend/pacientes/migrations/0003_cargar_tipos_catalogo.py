...
def cargar_tipos_catalogo(apps, schema_editor):
    ...
    (95, "ANTECEDENTE_RESPIRATORIO", "Antecedente respiratorio", False),
    ...
    (155, "DESTINO_MUESTRA", "Destino de la muestra", False),
    ...
    (225, "TIPO_ESTUDIO_MICROBIOLOGICO", "Tipo de estudio microbiológico", False),
